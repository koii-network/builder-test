def calculate_sum(my_list):
    ...
    Args:
        my_list (list): A list of integers to be summed with index weighting.
    
    Returns:
        int: The sum of numbers, where each number is multiplied by its index.
    ...
    # Calculate sum with index weighting
